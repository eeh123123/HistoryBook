	...
	<div class="commonDct" ref="getHeight">
		...
		<div class="floor2">
			<BaseTable pageSize="15" :handleCurrentChange="handleCurrentChange" :handleSizeChange="handleSizeChange" 
				...
				@selectedTableData="Left1_selectedTableData" 
				:currentPage = "currentPage"
				:callBack="cbFunc" :tableHead="tableHead" :tableData.sync="tableData" :tableHeight="tableData.tableHeight"></BaseTable>
		</div>
	</div>
</template>

<script>import person from '../sonVue/person.vue'
