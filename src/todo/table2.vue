			...
			<el-form-item>
				...
				<template>
					<el-table :data="GuanZhi_Data" class="tb-edit" style="width: 100%" highlight-current-row>
						...
						<el-table-column prop="address" label="品阶" width="200">
							<template slot-scope="scope">
								<sql-input v-model="scope.row.PinJie" @click.native="open_Dialog()" :option="option"></sql-input>
							</template>
						</el-table-column>
...
<!--		<Seconddialog :visible.sync="Seconddialog_show"></Seconddialog>
-->	</div>
</template>
