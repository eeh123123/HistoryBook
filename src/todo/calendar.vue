			...
			<el-form ref="form" :model="form" class="form">
				<div class="demo-image__placeholder">
					<div class="block">
						...
						<!--					<el-image :src="../assets/img/avator.jpg">
				...
				<div class="searchs">
					...
					<el-button @click="showTree()" style="width: 20%;">纪事表</el-button>
				...
				<el-upload class="upload-demo" action="http://localhost:8083/up" :on-preview="handlePreview" :on-remove="handleRemove" :before-remove="beforeRemove" multiple :limit="1" :on-exceed="handleExceed" :file-list="fileList">
		...
		methods: {
			...
			SearchMonthStories() {
				...
				$.get(vm.MYURL + 'SelectStories.do', {
					...
					for(var i = 0; i < vm.Event.length; i++) {
						console.log(moment(vm.value).format('YYYYMMDD'));
						if(vm.Event[i].Time == moment(vm.value).format('YYYYMMDD')) {
							vm.Title = vm.Event[i].Title;
							vm.Caption = vm.Event[i].Caption;
						}
