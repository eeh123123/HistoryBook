<template>
	<div class="main calendar">
		<div class="left">
			...
			<div v-show="RL_flag" class="tab RL" style="height: caLc(100% - 45px);">
				...
				<el-input v-model="RL.tiandi" placeholder="天干地支" style="
				"></el-input>
				<el-button icon="el-icon-search" @click="searchRL()">搜索</el-button>
				<BaseTable pageSize="15" :handleCurrentChange="handleCurrentChange" @selectedTableData="selectedTableData" 
				:page="tableData.page" :tableHead="tableHead" :tableData.sync="tableData" :tableHeight.sync="tableData.tableHeight"></BaseTable>
			</div>
		</div>
		<div class="right">
			<div class="top">
			...
			<div class="bottom">
				<el-form ref="form" class="form">
					...
					<el-form-item class="textareaForm">
						...
						<el-pagination background layout="prev, pager, next" :total="total" :page-size="pageSize" :current-page="page" current-change="SearchMonthStories">
						</el-pagination>
						<div class="tagdiv">
							是否精确：
							<el-switch
